    ...
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4">
        <div>
          ...
          <input {...register('namaMenu', { required: true })} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:outline-none" />
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select {...register('jenisPenerima', { required: true })} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:outline-none">
        ...
        <div>
          ...
          <input type="number" {...register('jumlahPorsi', { required: true, min: 1 })} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:outline-none" />
        </div>
        <div className="grid grid-cols-2 gap-4">
          {(['kalori', 'protein', 'karbohidrat', 'lemak'] as const).map((field) => (
            <div key={field}>
              ...
              <input type="number" step="0.1" {...register(field, { required: true, min: 0 })} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:outline-none" />
            </div>
          ))}
        </div>
        {mutation.error && (
