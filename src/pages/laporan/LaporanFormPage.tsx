    ...
    <div className="max-w-lg">
      ...
      >
        <div>
          ...
          <input {...register('judul', { required: true })} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:outline-none" />
        ...
        <div>
          ...
          <select {...register('jenis')} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:outline-none">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input type="date" {...register('periodeMulai', { required: true })} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:outline-none" />
          ...
          <div>
            ...
            <input type="date" {...register('periodeAkhir', { required: true })} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500 focus:outline-none" />
